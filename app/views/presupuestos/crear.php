...
<div class="container-fluid presupuestos-container">
    ...
    <div class="encabezado-presupuesto">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                ...
                <p>
                    Registra un nuevo presupuesto financiero para
                    planificar los ingresos, gastos y utilidad de la empresa.
                </p>
    ...
    <div class="seccion-presupuesto">
        ...
        <div class="titulo-seccion">
            ...
            <p>
                Completa la información de la empresa, periodo,
                valores financieros y estado del presupuesto.
            </p>
        ...
        <form
            action="index.php?page=guardarPresupuesto"
            method="POST"
        >
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Selecciona la empresa para la cual se creará el presupuesto.
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Valor estimado de los ingresos para el periodo.
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Valor estimado de los gastos para el periodo.
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <textarea
                        ...
                        class="form-control"
                        rows="4"
                        placeholder="Escribe una descripción del presupuesto..."
                    ></textarea>

                    <div class="ayuda-campo">
                        Puedes agregar observaciones o información adicional
