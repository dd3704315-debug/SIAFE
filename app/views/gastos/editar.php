...
<div class="container-fluid gastos-container">
    ...
    <div class="seccion-gasto">
        ...
        <div class="titulo-seccion">
            ...
            <p>
                Actualiza los datos correspondientes al gasto
                seleccionado.
            </p>
        ...
        <form
            action="index.php?page=actualizarGasto"
            method="POST"
        >
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Empresa a la que pertenece el gasto.
                    </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Clasificación del gasto registrado.
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Ingresa el valor correspondiente al gasto.
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Número de factura, recibo o referencia,
                        si aplica.
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="ayuda-campo">
                        Define si el gasto permanece activo
                        o ha sido anulado.
                    </div>
