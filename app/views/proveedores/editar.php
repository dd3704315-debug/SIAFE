...
<div class="container-fluid proveedor-form-container">
    ...
    <div class="seccion-formulario">
        ...
        <form
            action="index.php?page=actualizarProveedor"
            method="POST"
        >
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nit_proveedor"
                        class="form-control"
                        value="<?= htmlspecialchars($proveedor["nit_proveedor"] ?? "") ?>"
                    >
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="<?= htmlspecialchars($proveedor["correo_proveedor"] ?? "") ?>"
                    >
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="<?= htmlspecialchars($proveedor["ciudad_proveedor"] ?? "") ?>"
                    >
                ...
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="<?= htmlspecialchars($proveedor["direccion_proveedor"] ?? "") ?>"
                    >
                    ...
                    >
                        ...
                        ?>
                            ...
                            <option
                                ...
                                <?= ($proveedor["categoria_proveedor"] === $categoria) ? "selected" : "" ?>
                            >
                ...
                <div class="col-md-4">
                    ...
                    >
                        ...
                        <option
                            value="Activo"
                            <?= $proveedor["estado_proveedor"] === "Activo" ? "selected" : "" ?>
                        >
                            Activo
                        </option>
                        ...
                        <option
                            value="Inactivo"
                            <?= $proveedor["estado_proveedor"] === "Inactivo" ? "selected" : "" ?>
                        >
                            Inactivo
                        </option>
